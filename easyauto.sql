...
--
-- Host: 127.0.0.1
-- Creato il: Mag 08, 2026 alle 17:12
...
-- Database: `easyauto`
--
CREATE DATABASE IF NOT EXISTS `easyauto` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `easyauto`;
...
CREATE TABLE `costi_regione` (
  ...
  `euro0U` float DEFAULT NULL,
  `euro1U` float DEFAULT NULL,
  `euro2U` float DEFAULT NULL,
  `euro3U` float DEFAULT NULL,
  `euro4U` float DEFAULT NULL,
  `euro5U` float DEFAULT NULL,
  `euro6U` float DEFAULT NULL,
  `euro0O` float DEFAULT NULL,
  `euro1O` float DEFAULT NULL,
  `euro2O` float DEFAULT NULL,
  `euro3O` float DEFAULT NULL,
  `euro4O` float DEFAULT NULL,
  `euro5O` float DEFAULT NULL,
  `euro6O` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `costi_regione` (`Regione`, `benzina`, `diesel`, `gpl`, `metano`, `euro0U`, `euro1U`, `euro2U`, `euro3U`, `euro4U`, `euro5U`, `euro6U`, `euro0O`, `euro1O`, `euro2O`, `euro3O`, `euro4O`, `euro5O`, `euro6O`) VALUES
('Abruzzo', 1.737, 2.062, 0.794, 1.511, 3.63, 3.51, 3.39, 3.27, 3.12, 3.12, 3.12, 5.45, 5.27, 5.08, 4.91, 4.69, 4.69, 4.69),
('Basilicata', 1.765, 2.08, 0.765, 1.567, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Bolzano', 1.767, 2.084, 0.857, 1.757, 2.7, 2.61, 2.52, 2.43, 2.32, 2.09, 1.96, 4.05, 3.92, 3.78, 3.65, 3.48, 3.13, 2.94),
('Calabria', 1.753, 2.073, 0.831, 1.645, 3.3, 3.19, 3.08, 2.97, 2.84, 2.84, 2.84, 4.95, 4.79, 4.62, 4.46, 4.26, 4.26, 4.26),
('Campania', 1.742, 2.059, 0.777, 1.541, 3.63, 3.51, 3.39, 3.27, 3.12, 3.12, 3.12, 5.45, 5.27, 5.08, 4.91, 4.69, 4.69, 4.69),
('Emilia Romagna', 1.734, 2.063, 0.794, 1.549, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Friuli Venezia Giulia', 1.745, 2.078, 0.791, 1.544, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Lazio', 1.731, 2.051, 0.788, 1.695, 3.3, 3.19, 3.08, 2.97, 2.84, 2.84, 2.84, 4.95, 4.79, 4.62, 4.46, 4.26, 4.26, 4.26),
('Liguria', 1.737, 2.062, 0.871, 1.555, 3.3, 3.19, 3.08, 2.97, 2.84, 2.84, 2.84, 4.95, 4.79, 4.62, 4.46, 4.26, 4.26, 4.26),
('Lombardia', 1.726, 2.058, 0.79, 1.559, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Marche', 1.726, 2.051, 0.808, 1.529, 3.24, 3.13, 3.02, 2.92, 2.79, 2.79, 2.79, 4.86, 4.7, 4.54, 4.37, 4.18, 4.18, 4.18),
('Molise', 1.759, 2.072, 0.811, 1.481, 3.53, 3.38, 3.24, 3.09, 2.76, 2.76, 2.76, 5.3, 5.07, 4.85, 4.63, 4.14, 4.14, 4.14),
('Piemonte', 1.724, 2.061, 0.79, 1.566, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Puglia', 1.748, 2.067, 0.775, 1.639, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Sardegna', 1.74, 2.079, 0.859, 0, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Sicilia', 1.752, 2.075, 0.82, 1.816, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Toscana', 1.733, 2.067, 0.8, 1.601, 3.47, 3.35, 3.23, 3.12, 2.71, 2.71, 2.71, 5.45, 5.37, 5.08, 4.94, 4.26, 4.26, 4.26),
('Trento', 1.745, 2.075, 0.807, 1.554, 3, 2.9, 2.8, 2.7, 2.58, 2.06, 1.96, 4.5, 4.35, 4.2, 4.05, 3.87, 3.1, 2.94),
('Umbria', 1.739, 2.059, 0.798, 1.546, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Valle d\'Aosta', 1.742, 2.069, 0.874, 0, 3, 2.9, 2.8, 2.7, 2.58, 2.58, 2.58, 4.5, 4.35, 4.2, 4.05, 3.87, 3.87, 3.87),
('Veneto', 1.728, 2.05, 0.796, 1.515, 3.3, 3.19, 3.08, 2.97, 2.84, 2.84, 2.84, 4.95, 4.79, 4.62, 4.46, 4.26, 4.26, 4.26);
...
('root', '[{\"db\":\"easyauto\",\"table\":\"costi_regione\"},{\"db\":\"easyauto\",\"table\":\"consumi_tipo\"},{\"db\":\"easyauto\",\"table\":\"costi_mantenimento\"},{\"db\":\"easyauto\",\"table\":\"consumi_100km\"},{\"db\":\"easyauto\",\"table\":\"auto\"},{\"db\":\"easyauto\",\"table\":\"motore\"}]');
...
('root', '2026-05-08 13:06:25', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"it\"}');
