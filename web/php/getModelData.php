...
try {
    ...
    if ($searchTerm !== '') {
        ...
        $stmt = $db->prepare("SELECT Auto.modello,Marca.nome as Marca,Auto.anno_Di_Produzione,Auto.immagine,Motore.cilindrata_CC,Motore.cavalli,Motore.alimentazione FROM auto join Motore join Marca on Auto.id_marca = Marca.id_Marca and Auto.id_motore = Motore.id_Motore WHERE Auto.modello = :name");
